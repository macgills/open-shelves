...
<title>${escapeHtml(title)} · Open Shelves</title><link rel="stylesheet" href="/open-shelves-/assets/site.css">
<script type="module" src="/open-shelves-/assets/site.js"></script></head>
<body><header><a class="brand" href="/open-shelves-/">Open Shelves</a><nav><a href="/open-shelves-/">Library</a><a href="/open-shelves-/about/">About</a></nav></header>
...
<h2><a href="/open-shelves-/books/${book.slug}/">${escapeHtml(book.title)}</a></h2>
